...
;=============================
   ...
   for id=0,nd-1 do begin
	...
	case key[id] of
		0:begin 
			dx[0,1]=yy[id]-yfit[id]
			dx[0,2]=yy[id+nd]-yfit[id+nd]
			dx[0,3]=yy[id+2*nd]-yfit[id+2*nd]
		end
		3:begin 
			dx[1,1]=yy[id]-yfit[id]
			dx[1,2]=yy[id+nd]-yfit[id+nd]
			dx[1,3]=yy[id+2*nd]-yfit[id+2*nd]
		end
		6:begin 
			dx[1,1]=yy[id]-yfit[id]
			dx[1,2]=yy[id+nd]-yfit[id+nd]
		...
		9:begin 
			dx[2,1]=yy[id]-yfit[id]
			dx[2,2]=yy[id+nd]-yfit[id+nd]
			dx[2,3]=yy[id+2*nd]-yfit[id+2*nd]
		end
		12:begin 
			dx[2,1]=yy[id]-yfit[id]
			dx[2,2]=yy[id+nd]-yfit[id+nd]
...
nbad=n_elements(bad)
 ...
 stop
            ...
            save,stks,stds,hd,res,fixed,bad,stks0,hd0,stds0,thr,wparam_calib,  $
                 file='/tmp_mnt/home/dst-sp/lib/data/'+strmid(hd[0].date,0,10)+telpos+hd[0].wave+'.sav'  ; change filename 2017 12/2  s.o 
            print,'saved /tmp_mnt/home/dst-sp/lib/data/'+strmid(hd[0].date,0,10)+telpos+hd[0].wave+'.sav'
   ...
   'loadfile':begin
      ...
      wparam_calib.loadfile=dialog_pickfile(path='/home/dst-sp/lib/data/',directory=0)
   ...
   "png":begin
      ...
      !x.thick=1 
      !y.thick=1
      plotres,stks[*,1:3],stds[*,1:3],hd,res,dd=dd,key=key
      wset,0
      outfile='/tmp_mnt/home/dst-sp/lib/data/figures/'+strmid(hd[0].date,0,10)+telpos+hd[0].wave+'_1.png'
      outfile='/tmp_mnt/home/dst-sp/lib/data/figures/'+strmid(hd[0].date,0,10)+telpos+hd[0].wave+'_1.png'
      write_png,outfile,tvrd(/true)
      print,'saved '+outfile
      wset,1
      outfile='/tmp_mnt/home/dst-sp/lib/data/figures/'+strmid(hd[0].date,0,10)+telpos+hd[0].wave+'_2.png'
      outfile='/tmp_mnt/home/dst-sp/lib/data/figures/'+strmid(hd[0].date,0,10)+telpos+hd[0].wave+'_2.png'
      write_png,outfile,tvrd(/true)
      print,'saved '+outfile
      wset,2
      outfile='/tmp_mnt/home/dst-sp/lib/data/figures/'+strmid(hd[0].date,0,10)+telpos+hd[0].wave+'_3.png'
      outfile='/tmp_mnt/home/dst-sp/lib/data/figures/'+strmid(hd[0].date,0,10)+telpos+hd[0].wave+'_3.png'
      write_png,outfile,tvrd(/true)
      print,'saved '+outfile
      outfile='/tmp_mnt/home/dst-sp/lib/data/'+strmid(hd[0].date,0,10)+telpos+hd[0].wave+'_err.sav'
      outfile='/tmp_mnt/home/dst-sp/lib/data/'+strmid(hd[0].date,0,10)+telpos+hd[0].wave+'_err.sav'
      save,dd,key,file=outfile
      print,'saved '+outfile
   end
   'eps':begin
      restore,wparam_calib.loadfile,/verb
      if hd[0].zd ge 0 then telpos='w' else telpos='e'
      outfile='/tmp_mnt/home/dst-sp/lib/data/figures/'+strmid(hd[0].date,0,10)+telpos+hd[0].wave+'_1.eps'
      set_plot,'ps'
...
wparam_calib={widget_param_calib, 			$
	file     :	'/sp_pub/save/20171128/camera02/cal*.sav',	$
	reffile  :	'/sp_pub/save/20171128/camera01/cal*.sav',	$
	bad      :	'-1,-1',	$
	;loadfile  :	'/home/observer/lib/sp/data/2016-12-02w5890.sav'	$
	loadfile  :	'/home/dst-sp/lib/data/2016-12-02w5890.sav'	$
	}
